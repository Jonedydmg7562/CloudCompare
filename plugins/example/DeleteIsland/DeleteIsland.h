#ifndef DELETE_ISLAND_HEADER
#define DELETE_ISLAND_HEADER
...
//! Example qCC plugin
/** Replace 'DeleteIsland' by your own plugin class name throughout and then
	check 'DeleteIsland.cpp' for more directions.
...
**/
class DeleteIsland : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
...
public:
	explicit DeleteIsland( QObject *parent = nullptr );
	~DeleteIsland() override = default;
